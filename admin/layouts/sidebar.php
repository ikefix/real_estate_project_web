<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown <?php if($cur_page == 'location-view.php'||$cur_page == 'location-add.php'||$cur_page == 'location-edit.php'||$cur_page == 'type-view.php'||$cur_page == 'type-add.php'||$cur_page == 'type-edit.php'||$cur_page == 'amenity-view.php'||$cur_page == 'amenity-add.php'||$cur_page == 'amenity-edit.php'||$cur_page == 'property-view.php') {echo 'active';} ?>">
